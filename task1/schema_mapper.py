...
class MR_Gender_Analyzer1(MRJob):
    ...
    def mapper(self, _, line):
        ...
        if column_values[1] == "Модель":
            MR_Gender_Analyzer1.columns = itemgetter(*([1] + ids))(column_values)
        else:
...
if __name__ == '__main__':
    data = []
    Gender_Analyzer = MR_Gender_Analyzer1(["source1.csv"])
    ...
    with open('source1.json', 'w', encoding='utf8') as json_file:
